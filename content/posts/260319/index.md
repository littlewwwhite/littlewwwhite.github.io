...
[上两篇文章]({{< relref "/posts/260310" >}})我用控制论和三个团队的实践建立了一个判断：harness 的边际贡献大于模型升级，context window 是 Agent 的意识而非内存。Random Labs 最近发布的 Slate 技术报告从一个完全不同的方向抵达了同一个结论——而且给出了一套我之前没见过的架构原语。
